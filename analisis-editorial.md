...
Lo único genuinamente nuevo: el cierre de la lectura zahorí de Ninhursag («Señora del Nacedero») con dos lugares reales del País Vasco-Navarro que el qanat aportaba y la pieza existente no tenía —el nacedero del Urederra («ur ederra», agua hermosa) en la sierra de Urbasa, y la garganta de Kakueta—. Verificación Hammurabeltz: ambos son reales y están bien documentados; corregida la ubicación de Kakueta, que el qanat daba como «Navarra» y en realidad está en Zuberoa (Sainte-Engrâce, Francia), justo al otro lado de la frontera con Navarra.

**Fallo de cuenca, detectado por Luis y corregido en la misma sesión.** El injerto se colocó primero en MESOPOTAMIA PROFUNDA, ampliando el párrafo de Ninhursag directamente —error: aunque la lectura zahorí nace ahí, Urederra/Urbasa/Kakueta son topónimos vascos, no mesopotámicos, y no tienen sitio en una pieza de Cara 3 Asia por mucho que el argumento resuene. Se trató como continuación de un párrafo ya existente en vez de aplicar el criterio de cuenca a la geografía real del contenido nuevo, que es donde debía haberse aplicado. Corregido: la frase se sacó de MESOPOTAMIA PROFUNDA y se injertó donde geográficamente pertenece, en DE URBELTZ A URGORRI · OURENSE Y ELGORRIAGA (Cara 1 Ibérico → Atlántico), como cierre de la sección de Elgorriaga —mismo tema (nacederos, guardianas del agua: lamiak bajo el espino), misma región real (Navarra/Zuberoa)—. De paso, corregida una errata preexistente en MESOPOTAMIA PROFUNDA («mil enios» → «miles de años»), sin relación con este qanat, que sí se queda.

Delta final: +60 palabras, +59 caracteres netos (injerto en pieza existente, sin piezas nuevas). Filas actualizadas: Mesopotamia (Palabras 3.355, Pág 13, sin cambio neto respecto al punto de partida); Cara 3 · Asia (Palabras 24.046, sin cambio neto); Cara 1 · Ibérico (Palabras 30.270→30.330); TOTAL DEL LIBRO (Palabras 188.454→188.514).

| Capa | Caracteres | Palabras | Piezas |
|---|---|---|---|
| URS | 815.140 | 136.133 | 68 |
| URIM | 338.329 | 52.381 | 95 |
| **urtz.html** (URS+URIM) | **1.153.469** | **188.514** | **163** |
...
### Cuadragesimosegunda actualización — 25/09/2026 (misma sesión, Q33 — bisturí en cuatro piezas, dos correcciones Hammurabeltz de fondo)

Q33 (MINO-TA-UR-O · TA-UR-US · TASSILI · ESCULT-UR-A · EL TORO GUARDIÁN DEL AGUA) mezclaba en un solo depósito cuatro hilos genuinamente distintos, sin más nexo que "el toro" como figura recurrente: el mito de Cnosos (Creta), el arte rupestre de Tassili (Sahara), un catálogo comparativo de toros-guardianes en cinco culturas dispersas, y una coda crítica sobre la tauromaquia moderna. Bisturí (Regla 35) aplicado hilo por hilo, con el criterio de cuenca reforzado esta sesión (comprobar la geografía de cada fragmento nuevo, no solo la de la pieza huésped):

- **Minotauro/Cnosos/Ariadna** no existía en ningún lugar del libro (verificado por búsqueda de "Minotauro", "Cnosos", "Ariadna", "Teseo": solo un uso metafórico de pasada en un pieza sobre Cuba). Cuenca única (Creta), pieza nueva: **MINO-TA-UR-O · EL LABERINTO DEL ACUÍFERO**, en Cara 2 · Europa → Europa Latina · Francia-Italia-Grecia (antes vacía salvo LIGURES). Corrección Hammurabeltz: el qanat afirmaba "literalmente" que el laberinto *era* una red de canales subterráneos; el hecho real y verificado es que Cnosos (~2000 a.C.) tenía cisternas, tuberías de terracota y drenaje pluvial documentados arqueológicamente, pero la lectura del laberinto-como-acuífero es interpretación declarada del libro, no un hallazgo arqueológico — reescrito para separar el dato real de la lectura zahorí sin dejar que una vista a la otra como si fueran lo mismo. Se incluyó como coda de cierre "el toro en el supermercado" (Joe Strummer, circo romano, tauromaquia), que encajaba mejor aquí —guardián asesinado, memoria degradada a mercancía— que colgado sin cuenca de la pieza de Tassili.
- **Escult-UR-A · Tassili** resultó mayormente redundante con la pieza ya existente **DE EKAIN A LOS URALES** (sección "T-UR-O · el toro de Tassili", Panibérico), que ya trataba el mismo yacimiento. Lo genuinamente nuevo (cifra de 15.000 grabados, datación por fases, fauna del Sahara verde, Tibesti) se injertó ahí en vez de crear pieza redundante. Corrección Hammurabeltz: verificadas las fases de Tassili (Arcaico ~10.000-7.500 a.C., Round Head, Bovidiano/Pastoral) y la cifra de grabados; el motivo de "discos solares entre los cuernos" se mantuvo pero explícitamente marcado como lectura sin consenso académico cerrado, no como hecho establecido; Tibesti se generalizó (ganado grabado en roca volcánica) porque la búsqueda no confirmó específicamente la pareja "toros junto a lagos de cráter" que proponía el depósito.
- **Gugalanna** (Toro Celestial, Sumeria) encajaba por cuenca real en la pieza ya existente **MESOPOTAMIA PROFUNDA** (Inanna ya es personaje de esa pieza), donde se injertó un nuevo apartado. Corrección Hammurabeltz de fondo: el qanat afirmaba que "su muerte causa inundaciones" — falso. El mito real es el inverso: Gugalanna, mientras vive, seca ríos y provoca terremotos; muere descuartizado por Gilgamesh y Enkidu sin que su muerte desate ningún diluvio. Reescrito con el mito verificado, incluida la lectura que conecta a Gugalanna con el Descenso de Inanna (esposo de Ereshkigal).
- **El catálogo comparativo** (Apis, Toros de Guisando, Gursil, Beigorri, Mzora) no tenía una cuenca única ni una tesis conectiva verificable —Egipto, Meseta ibérica, Numidia/Cartago, Euskal Herria y Marruecos no comparten más que la observación comparativa del propio proyecto, no una tradición difusionista documentada—. Convertido en semilla, no en pieza ni en injerto forzado, siguiendo el mismo criterio aplicado a Urederra/Urbasa/Kakueta dos actualizaciones atrás. Tres correcciones Hammurabeltz de fondo detectadas en el proceso: (1) Apis no es "Horus encarnado" —es la manifestación de Ptah en vida y se funde con Osiris (Osiris-Apis/Serapis) tras la muerte—; (2) la asociación de los Toros de Guisando con la palabra vasca *iturri* era una invención sin base —los vetones hablaban una lengua céltica/lusitana, no vascónica, y la función real de los verracos sigue en debate académico abierto (funeraria/protectora/marcador de vereda), sin relación con el agua específicamente—; (3) Beigorri no es un toro sino una vaca (*behi gorri*, "vaca roja" en euskera; la variante taurina se llama Zezengorri), es un espíritu guardián de cuevas y tesoros, y no existe relación documentada alguna con Ishkur/Urtzi mesopotámico —esa "hermandad" del depósito original no se sostiene—. Gursil (hijo de Amón y una vaca, según Corippus, llevado a la batalla por los lagüatanos) sí se verificó correcto. Mzora se mantuvo con los 167 monolitos confirmados, pero con la función de "calendario de desbordamiento" marcada como hipótesis sin respaldo documental.

Delta: +162 palabras (Gugalanna, injerto en MESOPOTAMIA PROFUNDA) +133 palabras (Tassili, injerto en DE EKAIN A LOS URALES) +531 palabras (pieza nueva MINO-TA-UR-O) +328 palabras (semilla nueva El toro guardián del agua) = **+1.154 palabras, dos piezas nuevas** (1 URIM sellable a futuro + 1 semilla). Filas actualizadas: Mesopotamia (Palabras 3.443→3.605); Cara 3 · Asia (Palabras 24.293→24.455, Pág 97→98); Europa Latina (URIM 1→2, Total2 5→6, Rayuelas 0→2, Palabras 8.341→8.872, Pág 33→35); Cara 2 · Europa (URIM 4→5, Total 13→14, Total2 17→18, Rayuelas 0→2, Palabras 21.219→21.750, Pág 85→87); Cara 1 · Ibérico (Palabras 30.207→30.340, Pág sin cambio en 121); TOTAL DEL LIBRO (URIM 62→63, Total 130→131, Semillas 26→27, Total2 164→166, Rayuelas 22→24, Palabras 188.689→189.843, Pág 755→759). La nueva semilla no se atribuyó a ninguna fila de Cara concreta en la tabla —no tiene cuenca única real— y solo se refleja en el Semillas/Total2 del TOTAL DEL LIBRO, consistente con la inconsistencia ya conocida de filas sin desglose granular (Panibérico, entre otras, tampoco tiene fila propia).

| Capa | Caracteres | Palabras | Piezas |
|---|---|---|---|
| URS | 815.140 | 136.133 | 68 |
| URIM | 351.428 | 53.710 | 98 |
| **urtz.html** (URS+URIM) | **1.166.568** | **189.843** | **166** |
| PERMAFROST | 281.662 | 56.174 | 75 qanats |
...
### Cuadragesimonovena actualización — 26/09/2026 (misma sesión, Q5 — BABEL: pieza nueva de cuatro actos, construida en diálogo extenso, con investigación externa incorporada)

Q5 (DE EKAIN A URUK · LA RUTA IMPOSIBLE) fue el primero del tramo Q1-Q8 con contenido genuinamente nuevo: una ruta migratoria especulativa del fonema UR desde Ekain hasta Uruk. Tras un intercambio largo con Luis —sobre el límite del método comparativo, el simbolismo fónico como alternativa al parentesco genético, el mito de Babel como posible respuesta real a la pregunta que la ruta deja abierta, y finalmente el riesgo de que UR se convierta en dogma— la pieza se amplió mucho más allá del qanat original, incorporando investigación nueva (Enmerkar y el Señor de Aratta, Génesis 10-11, y el archivo de investigación **SOCIALISMOS Y UR.pages**, recuperado del branch main de GitHub y transcrito con LibreOffice) y quedó construida en cuatro actos:

- **Acto I — La ruta**: el qanat original, corregido de fondo. La fecha de Ekain (35.000 a.C. en el depósito original) se corrige a la real (~12.700-14.000 años, Magdaleniense). El "fonema cósmico libre" que el qanat proponía como morfema superviviente intacto se reencuadra como **simbolismo fónico** (Blasi et al. 2016: asociaciones sonido-significado reales y publicadas sin herencia genética común), con aviso explícito de que un artículo específico sobre simbolismo del agua fue retractado —la advertencia exacta de cuánto cuidado exige este terreno—. Corregido también el topónimo finés "Kuruvesi" → Kiuruvesi. El bloque ya existente en DE EKAIN A LOS URALES (el "gesto vocal" del bebé/el río/el cometa) no se repite, solo se enlaza por rayuela.
- **Acto II — Babel**: material nuevo, verificado. Génesis 10:10 une textualmente Uruk y Babel un capítulo antes de la confusión de lenguas. Enmerkar y el Señor de Aratta (principios del III milenio a.C., anterior a la Biblia en más de mil años) contiene el precursor sumerio real de la "confusión de lenguas": Enki —el mismo dios que ya administra el UR en MESOPOTAMIA PROFUNDA, rayuela incluida— rompe la lengua única de la humanidad. Génesis 11 se presenta como lo que la erudición actual sostiene: composición postexílica, polémica deliberada contra el Enuma Elish y el Esagila de Babilonia. Se corrige la etimología de "ziggurat" (de zaqāru, "construir alto", sin relación real con el agua) y se documenta la cascada etimológica real Bab-ili→Babel como ejemplo, dentro de la propia historia, del método zahorí del libro funcionando de verdad. Nota de honestidad añadida: el mito de "confusión de lenguas" no es universal como el diluvio; es más probable una única cadena de transmisión Sumeria→Babilonia→Biblia que una convergencia independiente.
- **Acto III — Impugnación**: el método puesto contra sí mismo. El techo de 8.000-10.000 años del método comparativo, Oswalt y la cuantificación de coincidencias por azar, la comparación léxica masiva de Greenberg, Larry Trask y la crítica de Morvan a Bengtson, el estudio lexicoestadístico vasco-caucásico de 2024, la filogenética bayesiana como "suplemento, no reemplazo", las palabras ultraconservadas de Pagel et al. (2013), la genética antigua vasca como prueba de que la pregunta avanza por vías laterales, y la comparación con otros campos (FCC tras el LHC, Atapuerca 2025-2026, la paradoja de la información de los agujeros negros, Marte aplazado por ingeniería y no por pregunta). Cierra con ocho preguntas deliberadamente sin resolver.
- **Acto IV — Las Trece Tribus de UR**: la autocrítica del propio símbolo, a petición explícita de Luis. Auguste Comte y la Religión de la Humanidad (positivismo → iglesia real, con tres templos que siguen abiertos hoy en Brasil, origen del "Ordem e Progresso" de la bandera brasileña) como el caso documentado más preciso de ciencia-antidogma que acaba en culto. La carta de Proudhon a Marx (17/05/1846) citada en su forma casi literal, advirtiendo contra la fundación de una nueva ortodoxia. Rayuela a MINO-TA-UR-O (UR como mercancía, el mismo camino del toro al supermercado) y a RÍO CONGO: NATURALEZA O SISTEMA (donde Chesterton ya hacía, sin que lo supiéramos, el mismo argumento sobre "lengua aislada" que este capítulo aplica a Trask/Bengtson). Rayuela hacia adelante, la primera del libro, a la semilla del segundo proyecto **ITEM · DEL SÍMBOLO AL OBJETO DE CULTO** (nota añadida también en `ANOMALIA-RUPESTRE-II.md`).

Ubicada en Bonus Tracks, junto a CAP-T-UR-A/RUP-T-UR-A/VER-D-UR-A y B-UR-ZUM. Delta: +3.189 palabras, **una pieza nueva**. Filas actualizadas: Bonus Tracks (URIM 1→2, Total 3→4, Total2 3→4, Rayuelas 0→4, Palabras 8.040→11.229, Pág 32→45); TOTAL DEL LIBRO (URIM 63→64, Total 131→132, Total2 166→167, Rayuelas 24→28, Palabras 190.540→193.729, Pág 762→775).

| Capa | Caracteres | Palabras | Piezas |
|---|---|---|---|
| URS | 815.879 | 136.242 | 68 |
| URIM | 384.417 | 57.487 | 99 |
| **urtz.html** (URS+URIM) | **1.200.296** | **193.729** | **167** |
